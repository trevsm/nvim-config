...
local mappings = {
  ...
  L = {
    name = "Edit Config",
    i = {":e ~/.config/nvim/init.lua <CR>", "Edit Init"},
    p = {":e ~/.config/nvim/lua/user/plugins.lua <CR>", "Edit Plugins"},
  ...
  x = {
    name ="Errors",
    x = {"<cmd>TroubleToggle<cr>", "Normal"},
    w = {"<cmd>TroubleToggle workspace_diagnostics<cr>", "Workplace"},
